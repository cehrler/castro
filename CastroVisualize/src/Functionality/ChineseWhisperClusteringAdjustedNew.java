...
public class ChineseWhisperClusteringAdjustedNew extends ChineseWhisperClustering {
	
	public ChineseWhisperClusteringAdjustedNew() {}
	...
	{
		System.err.println("Chinese whisper adjustedNew!");
		
		double activationThresholdMultiplier = SettingsWindow.ChineseWhisperClusteringAdjusted_activationThresholdMultiplier;
		double activationThresholdIncrement = SettingsWindow.ChineseWhisperClusteringAdjusted_activationThresholdMultiplierIncrement;
		...
		for (int i = 0; i < numIterations; i++)
		{
			...
			activationThresholdMultiplier += activationThresholdIncrement;
		...
		System.err.println("Num of different clusters so far: " + listClassID.size());

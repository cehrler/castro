...
public class MichalMain {
	...
	private static void RunTest()
	{
		...
		SimMatrixElem sim = SimMatrixElem.CountFromVMindex(pomI, SimMatrixElem.SimilarityMeasure.manhattan);
		...
		SimMatrixElem simPers = SimMatrixElem.CountFromVMindex(persI, SimMatrixElem.SimilarityMeasure.manhattan);

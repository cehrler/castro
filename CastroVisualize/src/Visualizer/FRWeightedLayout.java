 ...
 */
public class FRWeightedLayout extends AbstractLayout<Functionality.Node, Functionality.Edge> implements IterativeContext {
    ...
    private Map<Functionality.Node, FRVertexData> frVertexData =
    	LazyMap.decorate(new HashMap<Functionality.Node,FRVertexData>(), new Factory<FRVertexData>() {
     ...
     */
    public FRWeightedLayout(Graph<Functionality.Node, Functionality.Edge> g) {
        super(g);
    }
     ...
     */
    public FRWeightedLayout(Graph<Functionality.Node, Functionality.Edge> g, Dimension d) {
        super(g, new RandomLocationTransformer<Functionality.Node>(d), d);
        initialize();
    ...
    public synchronized void step() {
        ...
        while(true) {
            ...
            try {
                for(Functionality.Node v1 : getGraph().getVertices()) {
                    calcRepulsion(v1);
                }
                break;
    ...
    protected void calcAttraction(Functionality.Edge e) {
...
//                if (isLocked(v2)) continue;
    ...
    protected FRVertexData getFRData(Functionality.Node v) {

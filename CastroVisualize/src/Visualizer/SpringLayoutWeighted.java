 ...
 */
public class SpringLayoutWeighted extends AbstractLayout<Functionality.Node,Functionality.Edge> implements IterativeContext {

    protected double stretch = 0.70;
    protected Transformer<Functionality.Edge, Integer> lengthFunction;
    protected int repulsion_range_sq = 100 * 100;
    protected double force_multiplier = 1.0 / 3.0;

    protected Map<Functionality.Node, SpringVertexData> springVertexData =
    	LazyMap.decorate(new HashMap<Functionality.Node, SpringVertexData>(),
    ...
    public SpringLayoutWeighted(Graph<Functionality.Node,Functionality.Edge> g) {

...
that would enable automatic highlighting of clusters in the graph. 
...
For this goal to be achieved the system has to optimal in terms of loading time and GUI performance and be scalable for collections 

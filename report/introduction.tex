...
We exemplify our approach on the Castro Speech Database \citeA{CastroDB} (CSDB), a collection of speeches and other documents by Fidel Castro. Our system includes keyword and meta-data search with automatic query 

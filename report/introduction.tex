...
more specific relations between any subset of presented documents. 
...
\emph{Document Indexing:} documents were indexed in four different manners in order to support document retrieval and serve as input for similarity calculations. Three indexes were based on the three types of identified named entities. The fourth indexing method was based on global vocabulary. Terms were weighted according to both tf and tf/idf.\\
...
the entities appearing in the query can be also retrieved, enabling historians to receive documents that might be relevant for their interests 

...
We exemplify our approach on the \citeA{CastroDB} (CSD), a collection of
...
\item[NE Recognition] A NE recognizer was used to identify \meta{Persons}, \meta{Locations} and \meta{Organizations} in each document.

As described in section \ref{sec:aliasing} string kernels allow more flexibility then other popular string similarity measures such as edit distance.
...
\lingform{NewDelhi} and \lingform{New Delhi}. Here, the additional value of the string kernel method comes in the form of associating a the shorter version of the

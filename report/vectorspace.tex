...
Similarity matrices are loaded on the startup of the application. Switching similarity measures or aliasing setting redraws the edges of the graph according to a different matrix. Choosing a weights for combination of NE's and possibly general vocabulary leads to on-the-fly computation of similarities based on a linear combination of values from the relevant precomputed similarity matrices.

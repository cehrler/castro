...
subdirectory is a file named \code{setup\_db.sh} This file must first be run by the user to include
the correct username and password of a system user with MySQL administrator privileges (by default
set to \code{root}). The script can then be run to set-up the necessary database structure.
